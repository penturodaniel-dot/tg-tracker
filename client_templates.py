    ...
    js = (
        ...
        'function _showContacts(list,cityLabel){'
          ...
          'if(phone){'
            ...
            'var phCity=document.createElement("span");'
            'phCity.className="cl-phone-city";'
            'phCity.textContent="\U0001f4de "+(cityLabel||"Phone");'
            'var phLink=document.createElement("a");'
            'phLink.className="cl-phone-num";'
            'phLink.href="tel:"+phone.replace(/ /g,"");'
            'phLink.textContent=phone;'
            'ph.appendChild(phCity);'
