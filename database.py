        ...
        with self._conn() as conn:
            with conn.cursor() as cur:
                ...
                _indexes = [
                    ...
                    "UPDATE campaign_channels SET invite_link = TRIM(invite_link) WHERE invite_link IS NOT NULL",
                    "UPDATE channels SET invite_link = TRIM(invite_link) WHERE invite_link IS NOT NULL",
